...
public class TutorialCompletionDialogue extends DialoguePlugin {
	 ...
	 */
	private static final Item[] STARTER_PACK = new Item[] { new Item(995, 75000), new Item(590, 1), new Item(303, 1), new Item(380, 20), new Item(1925, 1), new Item(1931, 1), new Item(8007, 5), new Item(8010, 5), new Item(15112, 5), new Item(4447, 1), new Item(2741, 1), new Item(14775, 1) };
		...
		if (npc.getId() == 2796 || TutorialSession.getExtension(player).getStage() >= 71) {
			...
			case 507:
				...
				case 2:
					...
					player.getInventory().add(new Item(14761, 1));
					player.getInventory().add(new Item(14762, 1));
					player.getInventory().add(new Item(14763, 1));
					break;
				case 3:
			...
			case 520:
				...
				player.getProperties().setTeleportLocation(new Location(3222, 3218));
