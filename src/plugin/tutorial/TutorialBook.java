...
public final class TutorialBook extends Book {
	...
	private static final PageSet[] PAGES = new PageSet[] { 
		new PageSet(
				new Page(
						...
						new BookLine("in Barbarian Village in order", 59), new BookLine("to gain a a great amount of", 60), new BookLine("coins to start with. Also", 61),
						new BookLine("Consider collecting skilling", 62), new BookLine("materials to sell in bulk", 63), new BookLine("to the Gnome at home.", 64), 
						...
						new BookLine("www.aincrad.co.", 59), new BookLine("We wholeheartedly look over", 60), new BookLine("and consider all suggestions.", 61))),
	...
	public TutorialBook(final Player player) {
		super(player, "Aincrad Starter Book", 1856, PAGES);
	}
