	...
	public boolean handle(int interfaceId, int buttonId) {
		...
		if(tut_stage < TutorialSession.MAX_STAGE){
			...
			case 13:
				...
				break;
			case 14:
				interpreter.sendDialogues(npc, null, "Many players prefer to start with leveling their Slayer skill.", "The skill is profitable because of the vast amount of items","that come with defeating monsters in combat. Speak", "to Turael South of the bank. He is the lowest level");
				stage = 15;
				break;
			case 15:
				...
				break;
			case 16:
				interpreter.sendDialogues(npc, null, "As for other money-making methods, consider all of the other", "skills available to you. You may chop down Magic trees and","sell the valuable logs to players, or you may even catch", "raw shrimp and sell them to the Gnome.");
				stage = 17;
				break;
			case 17:
			...
			case 18:
				...
				break;
			case 19:
				interpreter.sendDialogues(npc, null, "First of all, we've provided Teleport tabs in your inventory" , " you can use them to travel to main cities such as Varrock", " there you will find activites such as the Grand-exchange which auto sell teleports.");
				stage = 21;
				break;
			case 21:
			...
			case 29:
				...
				break;
			case 30:
				interpreter.sendDialogue("Skill content:", "All skills are functioning.");
				stage = 31;
				break;
			case 31:
