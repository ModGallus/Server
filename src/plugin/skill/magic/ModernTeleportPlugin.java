...
public final class ModernTeleportPlugin extends MagicSpell {
	...
	public Plugin<SpellType> newInstance(SpellType arg) throws Throwable {
		...
		// house
		SpellBook.MODERN.register(23, new ModernTeleportPlugin(40, 50, Location.create(2953, 3224, 0), new Item(Runes.LAW_RUNE.getId()), new Item(Runes.AIR_RUNE.getId(), 1), new Item(Runes.EARTH_RUNE.getId(), 1)));
		// camelot
