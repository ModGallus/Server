	...
	public boolean interact(Entity e, final Node node, Option option) {
		...
		case "use":
			...
			case 42287:
				player.teleport(Location.create(2430, 3424, 0));
				break;
			case 42339:// smoke devil exit
				player.teleport(Location.create(2356, 9782, 0));
				break;
			case 42295://smoke devil enterance
				player.teleport(Location.create(3677, 5775, 0));
				break;
			case 42288://kalphitecrevice
				player.teleport(Location.create(3486, 9510, -2));
			case 42340:
