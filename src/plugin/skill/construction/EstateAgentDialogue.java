...
public final class EstateAgentDialogue extends DialoguePlugin {
	...
	public boolean handle(int interfaceId, int buttonId) {
		...
		case 10:
			...
			break;
		case 11:
			interpreter.sendOptions("Select an Option", "RIMMINGTON", "TAVERLY");
			//			interpreter.sendOptions("Select an Option", "RIMMINGTON", "TAVERLY","POLLNIVNEACH","RELLEKKA","BRIMHAVEN","YANILLE");
