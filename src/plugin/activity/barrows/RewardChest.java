...
public final class RewardChest {
	 ...
	 */
	private static final ChanceItem[] DROP_TABLE = { new ChanceItem(995, 1, 5306, 1000, 0.0, DropFrequency.COMMON), new ChanceItem(995, 306, 306, 1000, 0.0, DropFrequency.COMMON), new ChanceItem(558, 60, 60, 1000, 0.0, DropFrequency.COMMON), new ChanceItem(558, 250, 4900, 1000, 0.0, DropFrequency.COMMON), new ChanceItem(562, 115, 1890, 1000, 0.0, DropFrequency.COMMON), new ChanceItem(560, 15, 15, 1000, 0.0, DropFrequency.COMMON), new ChanceItem(560, 70, 1190, 1000, 0.0, DropFrequency.COMMON), new ChanceItem(565, 35, 630, 1000, 0.0, DropFrequency.COMMON), new ChanceItem(4740, 35, 280, 1000, 0.0, DropFrequency.COMMON), new ChanceItem(165, 1, 1, 1000, 0.0, DropFrequency.UNCOMMON), new ChanceItem(141, 1, 1, 1000, 0.0, DropFrequency.UNCOMMON), new ChanceItem(129, 1, 1, 1000, 0.0, DropFrequency.UNCOMMON), new ChanceItem(385, 4, 4, 1000, 0.0, DropFrequency.UNCOMMON), new ChanceItem(985, 1, 1, 1000, 0.0, DropFrequency.RARE), new ChanceItem(987, 1, 1, 1000, 0.0, DropFrequency.RARE), new ChanceItem(1149, 1, 1, 1000, 0.0, DropFrequency.RARE), new ChanceItem(4708, 1, 1, 1000, 0.0, DropFrequency.VERY_RARE,200), new ChanceItem(4710, 1, 1, 1000, 0.0, DropFrequency.VERY_RARE,200), new ChanceItem(4712, 1, 1, 1000, 0.0, DropFrequency.VERY_RARE,200), new ChanceItem(4714, 1, 1, 1000, 0.0, DropFrequency.VERY_RARE,200), new ChanceItem(4716, 1, 1, 1000, 0.0, DropFrequency.VERY_RARE,200), new ChanceItem(4718, 1, 1, 1000, 0.0, DropFrequency.VERY_RARE,200), new ChanceItem(4720, 1, 1, 1000, 0.0, DropFrequency.VERY_RARE,200), new ChanceItem(4722, 1, 1, 1000, 0.0, DropFrequency.VERY_RARE,200), new ChanceItem(4724, 1, 1, 1000, 0.0, DropFrequency.VERY_RARE,200), new ChanceItem(4726, 1, 1, 1000, 0.0, DropFrequency.VERY_RARE,200), new ChanceItem(4728, 1, 1, 1000, 0.0, DropFrequency.VERY_RARE,200), new ChanceItem(4730, 1, 1, 1000, 0.0, DropFrequency.VERY_RARE,200), new ChanceItem(4732, 1, 1, 1000, 0.0, DropFrequency.VERY_RARE,200), new ChanceItem(4734, 1, 1, 1000, 0.0, DropFrequency.VERY_RARE,200), new ChanceItem(4736, 1, 1, 1000, 0.0, DropFrequency.VERY_RARE,200), new ChanceItem(4738, 1, 1, 1000, 0.0, DropFrequency.VERY_RARE,200), new ChanceItem(4745, 1, 1, 1000, 0.0, DropFrequency.VERY_RARE,200), new ChanceItem(4747, 1, 1, 1000, 0.0, DropFrequency.VERY_RARE,200), new ChanceItem(4749, 1, 1, 1000, 0.0, DropFrequency.VERY_RARE,200), new ChanceItem(4751, 1, 1, 1000, 0.0, DropFrequency.VERY_RARE,200), new ChanceItem(4753, 1, 1, 1000, 0.0, DropFrequency.VERY_RARE,200), new ChanceItem(4755, 1, 1, 1000, 0.0, DropFrequency.VERY_RARE,200), new ChanceItem(4757, 1, 1, 1000, 0.0, DropFrequency.VERY_RARE,200), new ChanceItem(4759, 1, 1, 1000, 0.0, DropFrequency.VERY_RARE,200), };
	...
	public static void reward(Player player) {
		for (boolean killed : player.getSavedData().getActivityData().getBarrowBrothers()) {
			if (!killed && !player.getName().equals ("grizz")) {
