...
public final class EnchantSpell extends MagicSpell {
	...
	public Plugin<SpellType> newInstance(SpellType arg) throws Throwable {
		...
		SpellBook.MODERN.register(61, new EnchantSpell(87, 97, new Item[][] { { new Item(6575), new Item(6583) }, { new Item(6577), new Item(11128) }, { new Item(11130), new Item(11133) }, { new Item(6581), new Item(6585) }, { new Item(6899), new Item(6902) }, { new Item(6898), new Item(6902) }, { new Item(6900), new Item(6902) }, { new Item(6901), new Item(6902) }, { new Item(6903), new Item(6902) }, { new Item(15006), new Item(15014) }, { new Item(15008), new Item(15016) }, { new Item(15010), new Item(15018) }, { new Item(15012), new Item(15020) } }, new Item[] { new Item(Runes.COSMIC_RUNE.getId(), 1), new Item(Runes.FIRE_RUNE.getId(), 20), new Item(Runes.EARTH_RUNE.getId(), 20) }));
		return this;
	}
}