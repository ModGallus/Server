...
public class ExplorerJackDialogue extends DialoguePlugin {
	...
	public boolean handle(int interfaceId, int buttonId) {
		...
		case 4:
			...
			break;
		case 10:
			npc("Ah, well it's a diary that helps you keep track of", "particular achievements you've made in the world of", "WildScape Pk. In Lumbridge and Draynor i can help you", "discover some very useful things indeed.");
			stage++;
			break;
		case 11:
