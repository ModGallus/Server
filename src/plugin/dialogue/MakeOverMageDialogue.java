...
public class MakeOverMageDialogue extends DialoguePlugin {
	...
	public boolean handle(int interfaceId, int buttonId) {
		switch (stage) {
		case 0:
			interpreter.sendDialogues(npc, FacialExpression.NORMAL, "I can alter your physical form for a small fee of", "only 500 gold coins! Would you like me to perform my", "magics upon you?");
			stage = 1;
			break;
		case 1:
		...
		case 20:
			if (player.getInventory().contains(995, 500)) {
				...
				interpreter.sendDialogues(player, FacialExpression.NORMAL, "I don't have 500 gold coins on me...");
				stage = 21;
			}
			break;
		case 21:
		...
		case 25:
			if(!player.getEquipment().isEmpty()){
				...
				player.sendMessage("You pay the mage 500 coins.");
			}
			break;
		case 10:
