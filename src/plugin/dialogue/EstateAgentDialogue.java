...
import org.areillan.game.content.skill.member.construction.HousingStyle;
...
public final class EstateAgentDialogue extends DialoguePlugin {
	...
	public boolean handle(int interfaceId, int buttonId) {
		...
		case 0:
			if (player.getHouseManager().hasHouse()) {
				interpreter.sendOptions("Select an Option", "Can you move my house please?", "Can you redecorate my house please?", "Abandon House", "Tell me about houses", "Tell me about that skillcape you're wearing.");
				stage = 1;
			} else {
		...
		case 1:
			...
			case 2:
				...
				break;
			case 3:
				interpreter.sendDialogues(player, FacialExpression.NORMAL, "I'd like to abandon my house and start again.");
				stage = 60;
				break;
			case 4:
		...
		case 7:
			...
			break;
		case 10:
			npc("Where would you like to move it to?");
			stage = 11;
			break;
		case 11:
			interpreter.sendOptions("Select an Option", "Rimmington", "Taverly","Pollnivneach","More");
			stage = 12;
			break;
		case 12:
			switch (buttonId) 
			{
				case 1:
				{
					player.getHouseManager().setLocation(HouseLocation.RIMMINGTON);
					npc("Your house has been moved to Rimmington.");
					stage = 150;
					break;
					//rimm
				}
				case 2:
				{
					player.getHouseManager().setLocation(HouseLocation.TAVERLY);
					npc("Your house has been moved to Taverly.");
					stage = 150;
					break;
					//taverly
				...
				case 3:
				{
					player.getHouseManager().setLocation(HouseLocation.POLLNIVNEACH);
					npc("Your house has been moved to Pollnivneach.");
					stage = 150;
					break;
					//pollnivneach
				}
				case 4:
				{
					interpreter.sendOptions("Select an Option", "Rellekka", "Brimhaven","Yanille","Previous");
					stage = 13;
					break;
					//rellekka
				}
		...
		case 13:
			...
			{
			case 1:
				player.getHouseManager().setLocation(HouseLocation.RELLEKKA);
				npc("Your house has been moved to Rellekka.");
				stage = 150;
				break;
			case 2:
				player.getHouseManager().setLocation(HouseLocation.BRIMHAVEN);
				npc("Your house has been moved to Brimhaven.");
				stage = 150;
				break;
			case 3:
				player.getHouseManager().setLocation(HouseLocation.YANILLE);
				npc("Your house has been moved to Yanille.");
				stage = 150;
				break;
			case 4:
				interpreter.sendOptions("Select an Option", "Rimmington", "Taverly","Pollnivneach","More");
		...
		case 39:
			...
			break;
		case 60:
			interpreter.sendDialogues(npc, FacialExpression.NORMAL, "If that's what you wish, I'll have some people take care of it.","The house will be relocated back to Rimmington.");
			player.getHouseManager().create(HouseLocation.RIMMINGTON);
			stage = 150;
			break;
		case 90:
	...
	private void redecorate(HousingStyle style) {
		...
		if (!player.getInventory().contains(995, style.getCost())) {
