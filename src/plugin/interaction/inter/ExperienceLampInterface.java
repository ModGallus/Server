	...
	public boolean handle(Player player, Component component, int opcode, int button, int slot, int itemId) {
		...
		if (button == 2) {
			...
			if (type != null && type != Lamps.GENIE_LAMP) {
				...
				player.getDialogueInterpreter().open(70099, new Object[] { "The lamp gives you " + (int) experience + " " + Skills.SKILL_NAME[skillType.skill] + " experience." });
			}
