...
public class TeleTabsOptionPlugin extends OptionHandler {
	...
	public enum TeleTabs {
		VARROCK_TELEPORT(8007, Location.create(3212, 3423, 0), 35), LUMBRIDGE_TELEPORT(8008, Location.create(3222, 3218, 0), 41), FALADOR_TELEPORT(8009, Location.create(2966, 3380, 0), 47), CAMELOT_TELEPORT(8010, Location.create(2757, 3477, 0), 55.5), ADDOUGNE_TELEPORT(8011, Location.create(2662, 3307, 0), 61), TELEPORT_TO_HOUSE(8013, Location.create(2953, 3224, 0), 60), WATCH_TOWER_TELEPORT(8012, Location.create(2548, 3114, 0), 68), ZULRAH_TELEPORT(14976, Location.create(2199,3056, 0), 0), RELLEKKA_TELEPORT(15112, Location.create(2659,3657,0), 0);
	...
	public Plugin<Object> newInstance(Object arg) throws Throwable {
		...
		ItemDefinition.setOptionHandler("teleport", this);
		return this;
	}
}
