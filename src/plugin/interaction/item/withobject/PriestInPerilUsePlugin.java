...
public class PriestInPerilUsePlugin extends UseWithHandler {
	...
	/**
	 * (non-Javadoc)
	 * @see org.areillan.plugin.Plugin#newInstance(java.lang.Object)
	 */
	@Override
	...
	/**
	 * (non-Javadoc)
	 * @see org.areillan.game.interaction.UseWithHandler#handle(org.areillan.game.interaction.NodeUsageEvent)
	 */
	@Override
