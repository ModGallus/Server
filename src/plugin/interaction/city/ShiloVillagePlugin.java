...
public final class ShiloVillagePlugin extends OptionHandler {
	...
	public static final class VillageCartDialogue extends DialoguePlugin {
		...
		public boolean handle(int interfaceId, int buttonId) {
			switch (stage) {
			case 0:
				npc("I am offering a cart ride to " + (shilo ? "Shilo Village" : "Brimhaven") + " if you're", "interested? It will cost 10,000 gold coins. Is that Ok?");
				stage++;
				break;
			case 1:
			...
			case 3:
				...
				break;
			case 4:
				interpreter.sendDialogue("You pay the fare and hand 10,000 gold coins to " + npc.getName() + ".");
				stage++;
				break;
			case 5:
				if (player.getInventory().remove(new Item(995, 10000))) {
