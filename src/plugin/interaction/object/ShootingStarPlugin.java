...
import org.areillan.game.content.skill.SkillPulse;
...
public class ShootingStarPlugin extends OptionHandler {
	...
	private static final Object[][] CRASH_SITES = new Object[][] {
		{"Crafting Guild", Location.create(2940, 3280, 0)}, //Asgarnia
		{"Falador East Bank", Location.create(3030, 3349, 0)}, //Asgarnia
		{"Rimmington mining site", Location.create(2975, 3240, 0)},//Asgarnia
		{"Karamja NW mining site", Location.create(2737, 3223, 0)},//CrandorOrKaramja
		{"Brimhaven mining site", Location.create(2743, 3143, 0)},//CrandorOrKaramja
		{"South Crandor mining site", Location.create(2822, 3239, 0)},//CrandorOrKaramja
		{"Karamja mining site", Location.create(2854, 3032, 0)},//CrandorOrKaramja
		{"Shilo Village mining site", Location.create(2826, 2997, 0)},//CrandorOrKaramja
		{"Relleka mining site", Location.create(2682, 3700, 0)},//FremmyLandLunarIsle
		{"SE Ardougne mining site", Location.create(2600, 3232, 0)},//Kandarin
		{"Yanille Bank", Location.create(2603, 3087, 0)},//Kandarin
		{"Al Kharid bank", Location.create(3276, 3176, 0)},//Kharidian Desert
		{"Al Kharid mining site", Location.create(3296, 3297, 0)},//Kharidian Desert
		{"Duel Arena bank chest", Location.create(3342, 3267, 0)},//Kharidian Desert
		{"Nardah mining site", Location.create(3320, 2872, 0)},//Kharidian Desert
		{"Nardah bank", Location.create(3434, 2888, 0)},//Kharidian Desert
		{"SE Varrock mining site", Location.create(3292, 3353, 0)},//Misthalin
		{"SW Varrock mining site", Location.create(3176, 3362, 0)},//Misthalin
		{"Varrock east bank", Location.create(3259, 3407, 0)},//Misthalin
		{"Lumbridge Swamp mining site", Location.create(3227, 3150, 0)},//Misthalin
		{"Gnome stronghold Bank", Location.create(2460, 3432, 0)},//Gnome Stronghold
		{"Canifis Bank", Location.create(3504, 3487, 0)},//Morytania
		{"North Edgeville mining site", Location.create(3101, 3569, 0)},//Wildy
		{"South wilderness mining site", Location.create(3025, 3591, 0)},//Wildy
		{"Pirates' Hideout mining site", Location.create(3059, 3940, 0)},//Wildy
		{"Lava Maze mining site", Location.create(3062, 3885, 0)},//Wildy
		{"Mage Arena bank", Location.create(3093, 3962, 0)}//Wildy
	};
	...
	public class StarSpriteDialogue extends DialoguePlugin {
		 ...
		 */
		private static final double AMPLIFIER = 2;
