 ...
 * @author Life
 */
public final class MysteryBoxHardPlugin extends OptionHandler {
    ...
    private static final ChanceItem[] REWARDS = new ChanceItem[] { 
    	...
    	new ChanceItem(1619, 1, 5, DropFrequency.COMMON),//uncutruby
    	...
    	new ChanceItem(1150, 1, 5, DropFrequency.COMMON),//dmed
    	new ChanceItem(1305, 1, 1, DropFrequency.COMMON),//dragon longsword
    	...
    	new ChanceItem(565, 100, 1200, DropFrequency.UNCOMMON),//blood rune
    	...
    	new ChanceItem(450, 16, 270, DropFrequency.UNCOMMON),//addy ore
    	...
    	new ChanceItem(6688, 8, 27, DropFrequency.UNCOMMON),//sara brew(3)
    	...
    	new ChanceItem(2364, 9, 30, DropFrequency.RARE),//rune bar
    	...
    	new ChanceItem(5315, 1, 20, DropFrequency.RARE),//yew seed
    	...
    	new ChanceItem(3204, 1, 1, DropFrequency.RARE),//dragon halberd
    	new ChanceItem(11732, 1, 1, DropFrequency.RARE),//dboots
	
	};

	@Override
	public Plugin<Object> newInstance(Object arg) throws Throwable {
		ItemDefinition.forId(15080).getConfigurations().put("option:open", this);
		return this;
	}
