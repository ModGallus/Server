 ...
 * @author Life
 */
public final class MysteryBoxMediumPlugin extends OptionHandler {
    ...
    private static final ChanceItem[] REWARDS = new ChanceItem[] { 
    	...
    	new ChanceItem(11255, 1, 3, DropFrequency.COMMON),//ninja impling jar
    	
    	new ChanceItem(985, 1, 1, DropFrequency.UNCOMMON),//half key
    	new ChanceItem(987, 1, 1, DropFrequency.UNCOMMON),//half key
    	new ChanceItem(12158, 10, 18, DropFrequency.UNCOMMON),//green charml
	...
	public Plugin<Object> newInstance(Object arg) throws Throwable {
		ItemDefinition.forId(15079).getConfigurations().put("option:open", this);
		return this;
	}
