 ...
 * @version 1.0
 */
public final class DarknessSpecialHandler extends RangeSwingHandler implements Plugin<Object> {
	...
	public Plugin<Object> newInstance(Object arg) throws Throwable {
		if (CombatStyle.RANGE.getSwingHandler().register(15084, this) && CombatStyle.RANGE.getSwingHandler().register(13405, this) && CombatStyle.RANGE.getSwingHandler().register(14803, this) && CombatStyle.RANGE.getSwingHandler().register(14804, this) && CombatStyle.RANGE.getSwingHandler().register(14805, this) && CombatStyle.RANGE.getSwingHandler().register(14806, this))
			;
		return this;
	}
