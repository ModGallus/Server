...
import org.areillan.game.node.entity.combat.equipment.Ammunition;
import org.areillan.game.node.entity.combat.equipment.RangeWeapon;
import org.areillan.game.node.entity.combat.equipment.Weapon;
import org.areillan.game.node.entity.combat.equipment.Weapon.WeaponType;
import org.areillan.game.node.entity.combat.handlers.RangeSwingHandler;
...
public final class DescentOfDarknessSpecialHandler extends RangeSwingHandler implements Plugin<Object> {
	...
	public Plugin<Object> newInstance(Object arg) throws Throwable {
		if (CombatStyle.RANGE.getSwingHandler().register(11235, this) && CombatStyle.RANGE.getSwingHandler().register(15084, this) && CombatStyle.RANGE.getSwingHandler().register(13405, this) && CombatStyle.RANGE.getSwingHandler().register(14803, this) && CombatStyle.RANGE.getSwingHandler().register(14804, this) && CombatStyle.RANGE.getSwingHandler().register(14805, this) && CombatStyle.RANGE.getSwingHandler().register(14806, this))
			;
		return this;
	}
	...
	public int swing(Entity entity, Entity victim, BattleState state) {
		...
		state.setFrozen(ItemDefinition.forId(state.getAmmunition().getItemId()).getName().contains("ragon javelin"));
