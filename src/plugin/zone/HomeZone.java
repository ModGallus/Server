 ...
 * 
 */
/*public final class HomeZone extends MapZone implements Plugin<Object> {
		...
		*//**
		...
		public boolean handle(int interfaceId, int buttonId) {
			...
			case 2:
				...
				break;
			case 3:
				interpreter.sendDialogues(8631, FacialExpression.OSRS_NORMAL, "Visit our website by heading to www.aincrad.co.", "Log-in to the website with your in-game details", "and then simply vote via the account panel in order", "to obtain your credits.");
				stage = 4;
				break;
			case 4:
	...
	public static final class TeleporterDialogue extends DialoguePlugin {
		...
		*//**
		...
		private static final Object[][][] TELEPORTS = new Object[][][] {
			...
			{{"Minigames"}, {"Pest Control", Location.create(2659, 2649, 0)}, {"Duel Arena", Location.create(3352, 3265, 0)}, {"Sorceress' Garden", Location.create(3315, 3163, 0)}, {"Warrior's Guild", Location.create(2881, 3546, 0)}, {"Puro Puro", Location.create(2592, 4317, 0)}, {"Fight Pits", Location.create(2399, 5178, 0)}, {"Clan Wars", Location.create(3272, 3687, 0)}, {"Magic Training Arena", Location.create(3363, 3298, 0)}}, 
		};
		...
		*//**
		...
		public boolean open(Object... args) {
			...
			interpreter.sendItemMessage(563, "This is the Aincrad teleporter. You may use it every","five minutes to freely teleport to many places.", (player.getSavedData().getGlobalData().getGlobalTeleporterDelay() > System.currentTimeMillis() ? "<col=CC4000>You are on cooldown for the next "+ (minutes)+" minute(s)." : ""));
			stage = -5;
			return true;
		}
		...
		public boolean handle(int interfaceId, int buttonId) {
			...
			case 2:
				...
				if (optionIndex == 2 && teleports[teleIndex] == "Puro Puro") {
					interpreter.sendDialogue("Happy Hunting!");
					break;
				}
	...
	*//**
	...
	private final void addObjects(){
		ObjectBuilder.add(new GameObject(604, new Location(1112, 1112)));
		addObject(new GameObject(12309, base.transform(3219, 9623, 0), 3));
		ObjectBuilder.add(new GameObject(12309, new Location(3219, 9623, 0, 3)));
	}
}*/