...
public class WaterFall extends Quest {
	...
	public void finish(Player player) {
		...
		player.getSkills().addExperience(Skills.STRENGTH, 7500);
		player.getSkills().addExperience(Skills.ATTACK, 7500);
		//player.getSkills().addExperience(Skills.HITPOINTS, 7500);
		//player.getSkills().addExperience(Skills.RANGE, 7500);
		//player.getSkills().addExperience(Skills.MAGIC, 7500);
		//player.getSkills().addExperience(Skills.PRAYER, 700);
		//player.getSkills().addExperience(Skills.SUMMONING, 500);
