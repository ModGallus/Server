...
public enum BossKillCounter {
	...
	ABYSSAL_DEMON(new int[] { 1615 }, "Abyssal Demon", 14976),
	CERBERUS(new int[] { 8632 }, "Cerberus", 14974),
	DEMONIC_GORILLA(new int[] { 8678 }, "Demonic gorilla", -1),
	TORTURED_GORILLA(new int[] { 8679 }, "Tortured Gorilla", -1),
	ZULRAH(new int[] { 8620, 8621, 8622 }, "Zulrah", 14654),
	WYVERN(new int[] { 3068 }, "Skeletal Wyvern", -1),
	SMOKE_BOSS(new int[] {8686}, "Thermonuclear smoke devil", 14644),
