package org.areillan.game.content.global;
...
public enum EnchantedJewellery {
	RING_OF_SLAYING(new String[] { "Slayer Tower", "Fremmenik Slayer Dungeon", "Pollniveach Slayer Dungeon", "Stronghold Slayer Cave" }, new Location[] { Location.create(3429, 3533, 0), Location.create(2793, 3615, 0), Location.create(3313, 2960, 0), Location.create(2435, 3427, 0) }, true, 13281, 13282, 13283, 13284, 13285, 13286, 13287, 13288), 
	RING_OF_DUELING(new String[] { "Duel Arena", "Castle Wars", "Clan Wars"}, new Location[] { Location.create(3314, 3235, 0), Location.create(2442, 3089, 0), Location.create(3266, 3686, 0)}, true, 2552, 2554, 2556, 2558, 2560, 2562, 2564, 2566), 
	AMULET_OF_GLORY(new String[] { "Edgeville", "Karamja", "Draynor Village", "Al-Kharid"}, new Location[] { Location.create(3087, 3495, 0), Location.create(2919, 3175, 0), Location.create(3104, 3249, 0), Location.create(3304, 3124, 0) }, 1712, 1710, 1708, 1706, 1704), 
	AMULET_OF_GLORY_T(new String[] { "Edgeville", "Karamja", "Draynor Village", "Al-Kharid"}, new Location[] { Location.create(3087, 3495, 0), Location.create(2919, 3175, 0), Location.create(3081, 3250, 0), Location.create(3304, 3124, 0) }, 10354, 10356, 10358, 10360, 10362), 
	GAMES_NECKLACE(new String[] { "Barbarian Outpost", "Burthorpe Games Room", "Corporeal Beast", "Bounty Hunter"}, new Location[] { Location.create(2520, 3571, 0), Location.create(2899, 3563, 0), Location.create(2885, 4372, 2), Location.create(3179, 3685, 0) }, true, 3853, 3855, 3857, 3859, 3861, 3863, 3865, 3867), 
	DIGSITE_PENDANT(new String[] {}, new Location[] { Location.create(3342, 3445, 0) }, true, 11194, 11193, 11192, 11191, 11190), 
	COMBAT_BRACELET(new String[] { "Champions' Guild", "Monastery", "Ranging Guild", "Warriors' Guild"}, new Location[] { Location.create(3191, 3365, 0), Location.create(3052, 3472, 0), Location.create(2657, 3439, 0), Location.create(2878, 3546, 0) }, 11118, 11120, 11122, 11124, 11126), 
	SKILLS_NECKLACE(new String[] { "Fishing Guild", "Mining Guild", "Crafting Guild", "Cooking Guild"}, new Location[] { Location.create(2611, 3392, 0), Location.create(3016, 3338, 0), Location.create(2933, 3290, 0), Location.create(3143, 3442, 0) }, 11105, 11107, 11109, 11111, 11113);
