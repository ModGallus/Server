...
public enum SkillingTool {
	/**
	 * Represents a Infernal Axe (Wooducutting).
	 */
	INFERNAL_AXE(14972, 65, 1.3D, new Animation(2846)),
	/**
	...
	/**
	 * Represents an adze (woodcutting).
	 */
	Inferno_Adze(13661, 61, 1.0D, new Animation(2846)),
	/**
	 ...
	 */
	INFERNO_ADZE(13661, 61, 1.5D, new Animation(10251)),
	
	/**
	 * Represents the Inferno Adze (mining)
	 */
	INFERNO_ADZE2(13661, 41, 1.5D, new Animation(10222));
	...
	public static SkillingTool getHatchet(Player player) {
		...
		} else if (checkTool(player, Skills.WOODCUTTING, SkillingTool.INFERNAL_AXE)) {
			tool = SkillingTool.INFERNAL_AXE;
		}
		return tool;
	}
