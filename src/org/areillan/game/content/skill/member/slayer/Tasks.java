package org.areillan.game.content.skill.member.slayer;
 ...
 */
public enum Tasks {
	ABERRANT_SPECTRES(new Task(new int[] { 1604, 1605, 1606, 1607 }, new String[] { "Aberrant spectres have an extremely potent stench that drains", "stats and life points. A nose peg, protects against the stench." }, 60, new Master[] { Master.DURADEL, Master.CHAELDAR, Master.SUMONA, Master.VANNAKA, Master.NIEVE }, true, Equipment.NOSE_PEG)),
	ABYSSAL_DEMONS(new Task(new int[] { 1615, 4230, }, new String[] { "Abyssal Demons are nasty creatures to deal with, they aren't really part, ", "of this realm, and are able to move very quickly to trap their prey" }, 85, new Master[] { Master.CHAELDAR, Master.DURADEL, Master.SUMONA, Master.NIEVE }, false)),
	...
	BANSHEE(new Task(new int[] { 1612 }, new String[] { "Banshees use a piercing scream to shock their enemies, you'll", "need some Earmuffs to protect yourself from them." }, 15, new Master[] { Master.TURAEL, Master.CHAELDAR, Master.SUMONA, Master.VANNAKA, Master.MAZCHNA }, true, Equipment.EARMUFFS)),
	BASILISKS(new Task(new int[] { 1616, 1617, 4228 }, new String[] { "A mirror shield is much neccesary when hunting these", "mad creatures." }, 40, new Master[] { Master.TURAEL, Master.MAZCHNA, Master.VANNAKA, Master.SUMONA, Master.CHAELDAR }, false)),
	...
	BLACK_DEMONS(new Task(new int[] { 84, 677, 4702, 4703, 4704, 4705, }, new String[] { "Black Demons are magic creatures that are weak to magic attacks.", "They're the strongest demon and very dangerous." }, 1, new Master[] { Master.DURADEL, Master.SUMONA, Master.NIEVE }, false)),
	...
	BLOODVELDS(new Task(new int[] { 1618, 1619, 6215, 7643, 7642 }, new String[] { "Bloodvelds are strange demonic creatures, they use their long rasping tongue", "to feed on just about anything they can find." }, 50, new Master[] { Master.VANNAKA, Master.SUMONA, Master.CHAELDAR, Master.DURADEL, Master.NIEVE }, false)),
	BLUE_DRAGONS(new Task(new int[] { 55, 4681, 4682, 4683, 4684, 5178, 52, 4665, 4666, }, new String[] { "Blue dragons aren't as strong as other dragons but they're still", "very powerful, watch out for their firey breath." }, 1, new Master[] { Master.CHAELDAR, Master.SUMONA, Master.DURADEL, Master.NIEVE }, false)),
	...
	CAVE_CRAWLERS(new Task(new int[] { 1600, 1601, 1602, 1603, }, new String[] { "The poisonous parts of them are presumably removed." }, 10, new Master[] { Master.MAZCHNA, Master.SUMONA, Master.CHAELDAR }, false)),
	CAVE_HORRORS(new Task(new int[] { 4353, 4354, 4355, 4356, 4357, }, new String[] { "A Cave horror wears a creepy mask, it is", "prefered to wear a witchwood icon." }, 58, new Master[] { Master.CHAELDAR, Master.SUMONA, Master.NIEVE }, false)),
	...
	DAGANNOTHS(new Task(new int[] { 1338, 1339, 1340, 1341, 1342, 1343, 1344, 1345, 1346, 1347, 2454, 2455, 2456, 2881, 2882, 2883, 2887, 2888, 3591, }, new String[] { "There are many types of Dagannoth, the most powerful being the three Dagannoth Kings." }, 1, new Master[] { Master.VANNAKA, Master.SUMONA, Master.NIEVE }, false)),
	...
	SMOKE_DEVILS(new Task(new int[] {8686, 6866}, new String[] {"A mutated version of Dust devils, need a facemask","Or a slayer helmet  to kill."}, 93, new Master[] { Master.NIEVE }, false)),
	DUST_DEVILS(new Task(new int[] { 1624 }, new String[] { "Dust Devils use clouds of dust, sand, ash and whatever", "else they can inhale to blind and disorientate", "their victims." }, 65, new Master[] { Master.VANNAKA, Master.SUMONA, Master.CHAELDAR, Master.DURADEL, Master.NIEVE }, true, Equipment.FACEMASK)),
	...
	ELVES(new Task(new int[] { 1184, 1183, 1185 }, new String[] { "Elves are quick, agile and vicious fighters which", "often favour bows and polearms." }, 1, new Master[] { Master.VANNAKA, Master.SUMONA, Master.CHAELDAR, Master.NIEVE }, false) {
		@Override
	...
	FIRE_GIANTS(new Task(new int[] { 110, 1582, 1583, 1584, 1585, 1586, 7003, 7004 }, new String[] { "Like other giants, Fire Giants often wield large weapons", "learn to recognise what kind of weapon it is, and act accordingly." }, 1, new Master[] { Master.CHAELDAR, Master.SUMONA, Master.DURADEL, Master.NIEVE }, false)),
	...
	GARGOYLES(new Task(new int[] { 1610, 1611, 6389 }, new String[] { "Gargoyles are winged creatures of stone. You'll need to fight them to", "near death before breaking them apart with a rock hammer." }, 75, new Master[] { Master.CHAELDAR, Master.DURADEL, Master.SUMONA, Master.NIEVE }, false, Equipment.ROCK_HAMMER)),
	...
	GREATER_DEMONS(new Task(new int[] { 83, 4698, 4699, 4700, 4701, 6208, 6206, 6204 }, new String[] { "Greater Demons are magic creatures so they are weak to magical attacks.", "They're the strongest demon and very dangerous." }, 1, new Master[] { Master.CHAELDAR, Master.SUMONA, Master.DURADEL, Master.NIEVE }, false)),
	...
	HELLHOUNDS(new Task(new int[] { 49, 3586, 6210, 6832, }, new String[] { "Hellhounds are mid to high level demons." }, 1, new Master[] { Master.CHAELDAR, Master.SUMONA, Master.NIEVE }, false)),
	...
	IRON_DRAGONS(new Task(new int[] { 1591 }, new String[] { "Iron dragons aren't as strong as other dragons but they're still", "very powerful, watch out for their firey breath." }, 1, new Master[] { Master.CHAELDAR, Master.SUMONA, Master.DURADEL, Master.NIEVE }, false, 40 | 59 << 16)),
	...
	KALPHITES(new Task(new int[] { 1153, 1154, 1155, 1156, 1157, 1158, 1159, 1160, 1161 }, new String[] { "Kalaphite are large insects which live in great hives under the desert sands." }, 1, new Master[] { Master.MAZCHNA, Master.SUMONA, Master.CHAELDAR, Master.NIEVE }, false)),
	...
	KURASKS(new Task(new int[] { 1608, 1609, 4229 }, new String[] { "A kurask is a very quick creature." }, 70, new Master[] { Master.CHAELDAR, Master.SUMONA, Master.NIEVE }, false)),
	...
	NECHRYAELS(new Task(new int[] { 1613 }, new String[] { "Nechryael are demons of decay which summon small winged beings which", "help them fight their victems." }, 80, new Master[] { Master.CHAELDAR, Master.SUMONA, Master.DURADEL, Master.NIEVE }, false)),
	...
	RED_DRAGONS(new Task(new int[] { 53, 4669, 4670, 4671, 4672, 1589, 3588, 4667, 4668, }, new String[] { "Red dragons aren't as strong as other dragons but they're still", "very powerful, watch out for their firey breath." }, 1, new Master[] { Master.DURADEL, Master.SUMONA,  }, false) {
		@Override
		public boolean isDisabled() {
			return true;
		}
	...
	SPIRTUAL_MAGES(new Task(new int[] { 6221, 6231, 6257, 6278 }, new String[] { "They are dangerous, they hit with mage." }, 83, new Master[] { Master.CHAELDAR, Master.SUMONA, Master.DURADEL }, false)),
	...
	TERROR_DOG(new Task(new int[] { 5417, 5418 }, new String[] { "Terror Dogs are much like Wolves, they are pack creatures which will hunt in groups." }, 1, new Master[] { Master.VANNAKA, Master.SUMONA, Master.DURADEL }, false) {
		@Override
		public boolean isDisabled() {
			return true;
		}
	}),
	TROLLS(new Task(new int[] { 72, 3584, 1106, 1107, 1108, 1109, 1110, 1111, 1112, 1138, 1560, 1561, 1562, 1563, 1564, 1565, 1566, 1935, 1936, 1937, 1938, 1939, 1940, 1941, 1942, 3840, 3841, 3842, 3843, 3845, 1933, 1934, }, new String[] { "Trolls have a crushing attack, it's bets to wear a high crushing defence." }, 1, new Master[] { Master.CHAELDAR, Master.SUMONA, Master.DURADEL, Master.NIEVE }, false)),
	TUROTHS(new Task(new int[] { 1626, 1627, 1628, 1629, 1630 }, new String[] { "Turoths are Slayer monsters that require a Slayer level of 55 to kill" }, 55, new Master[] { Master.CHAELDAR, Master.SUMONA, Master.CHAELDAR, Master.NIEVE }, false)),
	...
	WARPED_TORTOISES(new Task(new int[] { 6296, 6297 }, new String[] { "A warped tortoise is not as slow as they look." }, 56, new Master[] { Master.DURADEL, Master.SUMONA, }, false) {
		@Override
		public boolean isDisabled() {
			return true;
		}
