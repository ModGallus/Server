...
public enum Master {
	...
	CHAELDAR(1598, new int[] {110, 170}, new int[] {10, 50, 150}) {
		@Override
		public boolean hasRequirment(Player player) {
			return player.getProperties().getCurrentCombatLevel() >= 70;
		}
	},
	
	SUMONA(7780, new int[] {50, 160}, new int[] {11, 50, 160}) {
		@Override
		public boolean hasRequirment(Player player) {
			return player.getProperties().getCurrentCombatLevel() >= 80 && player.getSkills().getLevel(Skills.SLAYER) >= 35;
		}
	},
