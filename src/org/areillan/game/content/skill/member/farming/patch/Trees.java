package org.areillan.game.content.skill.member.farming.patch;
 ...
 */
public enum Trees {
	OAK(new TreeNode(new Item(5370), new Item(1521), 8, 4, 40, 15, new double[] { 14, 467.3 }, new Item(5969))), WILLOW(new TreeNode(new Item(5371), new Item(1519), 15, 6, 40, 30, new double[] { 25, 1456.5 }, new Item(5387))), MAPLE(new TreeNode(new Item(5372), new Item(1517), 24, 8, 40, 45, new double[] { 45, 3403.4 }, new Item(5397))), YEW(new TreeNode(new Item(5373), new Item(1515), 35, 10, 40, 60, new double[] { 81, 7069.9 }, new Item(6017, 10))), MAGIC(new TreeNode(new Item(5374), new Item(1513), 48, 12, 40, 75, new double[] { 145.5, 13768.3 }, new Item(5977, 25)));
