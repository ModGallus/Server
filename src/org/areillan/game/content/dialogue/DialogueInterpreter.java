...
import org.areillan.game.system.script.ScriptContext;
import org.areillan.game.system.script.ScriptManager;
import org.areillan.game.system.script.context.ItemMessageInstruction;
import org.areillan.game.system.script.context.NPCDialInstruction;
import org.areillan.game.system.script.context.OptionDialInstruction;
import org.areillan.game.system.script.context.PDialInstruction;
import org.areillan.game.system.script.context.PlainMessageInstruction;
...
public final class DialogueInterpreter {
	...
	public void handle(int componentId, int buttonId) {
		if (dialogueStage != null) {
			dialogueStage = ScriptManager.run(dialogueStage, player, key, buttonId - 1);
