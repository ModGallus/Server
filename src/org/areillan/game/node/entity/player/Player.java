package org.areillan.game.node.entity.player;
...
import org.areillan.game.container.impl.BankContainer;
import org.areillan.game.container.impl.EquipmentContainer;
import org.areillan.game.container.impl.InventoryListener;
import org.areillan.game.content.ame.AntiMacroHandler;
import org.areillan.game.content.dialogue.DialogueInterpreter;
import org.areillan.game.content.dialogue.DialoguePlugin;
import org.areillan.game.content.eco.ge.GrandExchange;
import org.areillan.game.content.global.ttrail.TreasureTrailManager;
...
import org.areillan.game.content.skill.member.farming.FarmingManager;
import org.areillan.game.content.skill.member.hunter.HunterManager;
import org.areillan.game.content.skill.member.slayer.SlayerManager;
import org.areillan.game.content.skill.member.summoning.familiar.FamiliarManager;
...
import org.areillan.game.node.entity.combat.handlers.ChinchompaSwingHandler;
import org.areillan.game.node.entity.combat.handlers.SalamanderSwingHandler;
import org.areillan.game.node.entity.combat.handlers.TridentOfSeasHandler;
import org.areillan.game.node.entity.npc.NPC;
import org.areillan.game.node.entity.player.ai.AIPControlDialogue;
import org.areillan.game.node.entity.player.ai.AIPlayer;
import org.areillan.game.node.entity.player.info.PlayerDetails;
import org.areillan.game.node.entity.player.info.RenderInfo;
...
import org.areillan.game.node.entity.player.link.BankPinManager;
import org.areillan.game.node.entity.player.link.BarcrawlManager;
import org.areillan.game.node.entity.player.link.ConfigurationManager;
import org.areillan.game.node.entity.player.link.GlobalData;
import org.areillan.game.node.entity.player.link.HintIconManager;
import org.areillan.game.node.entity.player.link.InterfaceManager;
import org.areillan.game.node.entity.player.link.IronmanManager;
import org.areillan.game.node.entity.player.link.IronmanMode;
import org.areillan.game.node.entity.player.link.PacketDispatch;
import org.areillan.game.node.entity.player.link.SavedData;
import org.areillan.game.node.entity.player.link.Settings;
import org.areillan.game.node.entity.player.link.SkullManager;
import org.areillan.game.node.entity.player.link.SpellBookManager;
import org.areillan.game.node.entity.player.link.WarningMessages;
import org.areillan.game.node.entity.player.link.appearance.Appearance;
import org.areillan.game.node.entity.player.link.audio.AudioManager;
import org.areillan.game.node.entity.player.link.diary.AchievementDiaryManager;
import org.areillan.game.node.entity.player.link.emote.EmoteManager;
import org.areillan.game.node.entity.player.link.grave.GraveManager;
import org.areillan.game.node.entity.player.link.music.MusicPlayer;
import org.areillan.game.node.entity.player.link.prayer.Prayer;
...
import org.areillan.game.node.entity.player.link.request.RequestManager;
...
import org.areillan.game.world.map.Viewport;
import org.areillan.game.world.map.build.DynamicRegion;
import org.areillan.game.world.map.zone.ZoneType;
import org.areillan.game.world.repository.Repository;
import org.areillan.game.world.update.MapChunkRenderer;
import org.areillan.game.world.update.NPCRenderer;
import org.areillan.game.world.update.PlayerRenderer;
import org.areillan.game.world.update.UpdateSequence;
import org.areillan.game.world.update.flag.PlayerFlags;
import org.areillan.game.world.update.flag.player.FaceEntityFlag;
import org.areillan.game.world.update.flag.player.FaceLocationFlag;
import org.areillan.game.world.update.flag.player.ForceChatFlag;
import org.areillan.net.IoSession;
import org.areillan.net.packet.PacketRepository;
import org.areillan.net.packet.context.DynamicSceneContext;
import org.areillan.net.packet.context.SceneGraphContext;
import org.areillan.net.packet.context.SkillContext;
...
String secret = "3ab6be46e1d6b21d59a3c3a0b9d0f6ef"; //YOUR SECRET KEY!
String email = "theofficialgallus@gmail.com"; //This is the one you use to login into RSPS-PAY
...
break;
	...
	public CombatSwingHandler getSwingHandler(boolean swing) {
		...
		if (style == CombatStyle.RANGE && equipment.getNew(3).getId() == 14861 || style == CombatStyle.RANGE && equipment.getNew(3).getId() == 10034 || style == CombatStyle.RANGE && equipment.getNew(3).getId() == 10033) {
			return ChinchompaSwingHandler.getInstance();
		}
		if (style == CombatStyle.RANGE && equipment.getNew(3).getId() == 14861) {
			return ChinchompaSwingHandler.getInstance();
		}
