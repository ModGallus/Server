package org.areillan.game.node.entity.player.link.request.trade;
...
import org.areillan.game.container.ContainerType;
import org.areillan.game.container.SortType;
...
public final class TradeContainer extends Container {
	...
	public void offer(final int slot, int amount) {
		...
		if (!tradeable(item) && player.getDetails().getRights() != Rights.ADMINISTRATOR) {
