package org.areillan.game.node.entity.player.info.portal;
...
import org.areillan.game.system.mysql.SQLColumn;
...
import org.areillan.game.system.mysql.impl.PlayerSQLHandler;
...
//		int playRights = result.getInt("rights");
//		if(playRights != 2){
//			SQLManager.close(connection);
