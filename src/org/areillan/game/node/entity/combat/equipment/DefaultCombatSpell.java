...
public final class DefaultCombatSpell extends CombatSpell {
	...
	public DefaultCombatSpell(NPC npc) {
		super(SpellType.BOLT, SpellBook.MODERN, 0, 0.0, -1, -1, npc.getProperties().getMagicAnimation(), npc.getDefinition().getCombatGraphics()[0], null, npc.getDefinition().getCombatGraphics()[2]);
