package org.areillan.game.world.map.zone.impl;
...
public class DonatorZone extends MapZone {
	...
	public void configure() {
		...
		ObjectBuilder.add(new GameObject(12309, new Location(3219, 9620, 0)));
		ObjectBuilder.add(new GameObject(36786, new Location(3209, 3221, 0)));
		ObjectBuilder.add(new GameObject(1293, new Location(2462, 3447, 0)));
