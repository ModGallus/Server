...
import org.areillan.game.system.mysql.SQLTable;
...
public final class CommunicationInfo {
	 ...
	 */
	private String clanName = "Home";

	/**
	 * The current clan this player is in.
	 */
	private String currentClan = "Home";
	...
	public void save(SQLTable table) {
		...
		//table.getColumn("online").updateValue(1);
	...
	public void sync(Player player) {
		...
		if (currentClan != null && (clan = ClanRepository.get(currentClan)) != null) {
			clan.enter(player);
		}
	}
