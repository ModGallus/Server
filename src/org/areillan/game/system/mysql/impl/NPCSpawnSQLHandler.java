...
public class NPCSpawnSQLHandler extends SQLEntryHandler<NPC> {
	...
	public NPCSpawnSQLHandler(NPC entry, String table, String column, String value) {
		super(entry, "aincradc_server.pc_npc_spawns", "npc_id", "" + entry.getId());
	}
	...
	public void parse() throws SQLException {
		...
		PreparedStatement statement = connection.prepareStatement("SELECT * FROM aincradc_server.npc_spawns");
