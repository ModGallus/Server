...
import org.areillan.game.node.entity.combat.equipment.BoltEffect;
...
public class RangeConfigSQLHandler extends SQLEntryHandler<Object> {
	...
	public RangeConfigSQLHandler() {
		super(null, "aincradc_server.range_configs", "", "");
	}
	...
	public void parse() throws SQLException {
		...
		statement = connection.prepareStatement("SELECT * FROM aincradc_server.ammo_configs");
