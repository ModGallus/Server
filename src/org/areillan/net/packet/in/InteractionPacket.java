 ...
 * @author Emperor
 */
public final class InteractionPacket extends IncomingPacket {

	@Override
	public void decode(Player p, int opcode, IoBuffer buffer) {
		super.decode(p, opcode, buffer);
