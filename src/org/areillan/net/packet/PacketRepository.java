...
import org.areillan.net.packet.in.ActionButtonPacket;
import org.areillan.net.packet.in.CameraMovementPacket;
import org.areillan.net.packet.in.ChatPacket;
import org.areillan.net.packet.in.ChatSettingsPacket;
import org.areillan.net.packet.in.ClanPacketHandler;
import org.areillan.net.packet.in.ClientFocusPacket;
import org.areillan.net.packet.in.CommandPacket;
import org.areillan.net.packet.in.CommunicationPacket;
import org.areillan.net.packet.in.DisplayUpdatePacket;
import org.areillan.net.packet.in.ExaminePacket;
import org.areillan.net.packet.in.IdlePacketHandler;
import org.areillan.net.packet.in.InteractionPacket;
import org.areillan.net.packet.in.InterfaceUseOnPacket;
import org.areillan.net.packet.in.ItemActionPacket;
import org.areillan.net.packet.in.MouseClickPacket;
import org.areillan.net.packet.in.MusicPacketHandler;
import org.areillan.net.packet.in.PingPacketHandler;
import org.areillan.net.packet.in.QuickChatPacket;
import org.areillan.net.packet.in.RegionChangePacket;
import org.areillan.net.packet.in.ReportAbusePacket;
import org.areillan.net.packet.in.RunScriptPacketHandler;
import org.areillan.net.packet.in.SlotSwitchPacket;
import org.areillan.net.packet.in.UpdateInterfaceCounter;
import org.areillan.net.packet.in.WalkPacket;
import org.areillan.net.packet.out.AccessMask;
import org.areillan.net.packet.out.AnimateInterface;
import org.areillan.net.packet.out.AnimateObjectPacket;
import org.areillan.net.packet.out.AudioPacket;
import org.areillan.net.packet.out.BuildDynamicScene;
import org.areillan.net.packet.out.CameraViewPacket;
import org.areillan.net.packet.out.ClearGroundItem;
import org.areillan.net.packet.out.ClearMinimapFlag;
import org.areillan.net.packet.out.ClearObject;
import org.areillan.net.packet.out.ClearRegionChunk;
import org.areillan.net.packet.out.CloseInterface;
import org.areillan.net.packet.out.CommunicationMessage;
import org.areillan.net.packet.out.Config;
import org.areillan.net.packet.out.ConstructGroundItem;
import org.areillan.net.packet.out.ConstructObject;
import org.areillan.net.packet.out.ContactPackets;
import org.areillan.net.packet.out.ContainerPacket;
import org.areillan.net.packet.out.DisplayModel;
import org.areillan.net.packet.out.GameMessage;
import org.areillan.net.packet.out.GrandExchangePacket;
import org.areillan.net.packet.out.HintIcon;
import org.areillan.net.packet.out.InstancedLocationUpdate;
import org.areillan.net.packet.out.InteractionOption;
import org.areillan.net.packet.out.Interface;
import org.areillan.net.packet.out.InterfaceConfig;
import org.areillan.net.packet.out.LoginPacket;
import org.areillan.net.packet.out.Logout;
import org.areillan.net.packet.out.MinimapState;
import org.areillan.net.packet.out.MusicPacket;
import org.areillan.net.packet.out.PingPacket;
import org.areillan.net.packet.out.PositionedGraphic;
import org.areillan.net.packet.out.RepositionChild;
import org.areillan.net.packet.out.RunEnergy;
import org.areillan.net.packet.out.RunScriptPacket;
import org.areillan.net.packet.out.SetWalkOption;
import org.areillan.net.packet.out.SkillLevel;
import org.areillan.net.packet.out.StringPacket;
import org.areillan.net.packet.out.SystemUpdatePacket;
import org.areillan.net.packet.out.UpdateAreaPosition;
import org.areillan.net.packet.out.UpdateClanChat;
import org.areillan.net.packet.out.UpdateGroundItemAmount;
import org.areillan.net.packet.out.UpdateRandomFile;
import org.areillan.net.packet.out.UpdateSceneGraph;
import org.areillan.net.packet.out.WeightUpdate;
import org.areillan.net.packet.out.WindowsPane;
...
public final class PacketRepository {
	...
	static {
		...
		INCOMING_PACKETS.put(111, new org.areillan.net.packet.in.GrandExchangePacket());
		...
		//INCOMING_PACKETS.put(69, packet); //remove
		...
		//INCOMING_PACKETS.put(77, packet); //remove
		//INCOMING_PACKETS.put(191, packet); //remove
		//INCOMING_PACKETS.put(139, packet); //remove
		//INCOMING_PACKETS.put(251, packet); //remove
		// INCOMING_PACKETS.put(55, packet); //remove
	}
