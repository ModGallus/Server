package org.areillan.net.lobby;
...
public final class WorldList {
	 ...
	 */
	static {
		addWorld(new WorldDefinition(1, 0, FLAG_MEMBERS | FLAG_LOOTSHARE, "Remake", "104.196.187.228", "USA", COUNTRY_USA));
		addWorld(new WorldDefinition(2, 0, FLAG_MEMBERS | FLAG_LOOTSHARE, "PvP", "24.152.194.212", "England", COUNTRY_USA));
	}
